...
class ProfileFragment(var userAccount: UserAccount?) : Fragment() {
    ...
    override fun onCreateView(
        ...
        // email, username 받아오기
        binding.userEmailText.text = userAccount?.emailId
...
//        val intent = Intent(this, )
        ...
        // 프로필 이미지 변경 버튼 누를 시 프로필 사진 storage에 업로드
        binding.profileChangeBtn.setOnClickListener{
            ...
            val storageReference = firebaseStorage.child(firebaseAuth.currentUser?.uid.toString()+"_profileImg")
